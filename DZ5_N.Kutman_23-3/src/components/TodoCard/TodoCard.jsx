    ...
    if (isEdit) {
        ...
        return <div className={ task.completed ? `${classes.todoCard} ${classes.done}`: classes.todoCard }>
            ...
            <div className={classes.todoTitle}>
                <ButtonAction task={task} handleClick={handleDone} type={'done'} >&#10004;</ButtonAction>
                <h3>{task.title}</h3>
            </div>

            <div className={classes.todoButtons}>
                <ButtonAction task={task} handleClick={handleDelete} type={'delete'} >&#10539;</ButtonAction>
                <ButtonAction task={task} handleClick={handleSelectEdit} type={'edit'} >&#9998;</ButtonAction>
            </div>
